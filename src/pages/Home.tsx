    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://i.ibb.co/7JF07193/Accra-Tour5.jpg" 
            alt="Hero Background" 
            className="w-full h-full object-cover ken-burns"
          />
          {/* Dark Overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/90 via-brand-primary/80 to-brand-primary/60"></div>
        </div>
